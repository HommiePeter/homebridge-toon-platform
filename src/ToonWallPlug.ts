       ...
       // private devType: string,
        ...
        if ((device) && (status)) {
            ...
            if (create_new) {
                ...
                this.service.addCharacteristic(this.platform.CustomCharacteristic.TotalPowerConsumption)
                ...
                this.service.updateCharacteristic(this.platform.CustomCharacteristic.CurrentPowerConsumption,this.wallplug_status.currentUsage);
                this.service.updateCharacteristic(this.platform.CustomCharacteristic.DailyPowerConsumption,this.wallplug_status.dayUsage);
                if (this.wallplug_status.currentUsage !== 0) {
